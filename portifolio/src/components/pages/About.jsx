        ...
        <section className={styles.flex} >
                <div className={styles.max_width}>
                    ...
                    <div>
                        ...
                        <p>
                            Sou apaixonado por tecnologia e por isso estou sempre buscando aprender coisas novas, me aperfeiçoar e me manter atualizado com o mercado. Tenho conhecimento em diversas tecnologias, como HTML, CSS, JavaScript, React, PHP, MySql, Node, Java, Python, C, entre outras.
                        </p>
                        <p>
